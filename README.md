Тест для сингри.
Сайт с возможностью регистрации.
Оставлять посты с фотографиями.
Возможность оценивания постов(вывод средней оценки).
Пагинация.

.htaccess настроен на работу из корневой локальной директории www.

настройка коннекта к бд- www/common/config/main-local.php.
