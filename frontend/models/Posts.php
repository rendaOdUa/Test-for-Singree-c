...
class Posts extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['rating', 'rating_count'], 'integer'],
            [['user_id'], 'integer'],
            [['date'], 'safe'],
            [['text'], 'string', 'max' => 200],
            [['avatarUrl'], 'string', 'max' => 200],
            [['title', 'content'], 'string', 'max' => 30],
            [['imageUrl'], 'string', 'max' => 400],
    ...
    {
        if ($this->validate()) {
            $urlUp = Yii::$app->basePath. '/web/uploads/' . $this->user_id . "/" . $this->str2url($this->title);
            $urlShow = '/uploads/' . $this->user_id . "/" . $this->str2url($this->title);
            if(!is_dir($urlUp)){
